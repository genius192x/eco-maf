...
***************************************************************************** */
    ...
    const addContent = document.querySelector(".content__type");
    window.addEventListener("click", (function(event) {
        if (event.target.hasAttribute("data-add")) {
            chatBtn.classList.toggle("open");
            addContent.classList.toggle("open");
        } else {
    ...
    function initSliders() {
        if (document.querySelector(".full")) new Swiper(".full", {
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
        ...
        if (document.querySelector(".swiper-catalog")) new Swiper(".swiper-catalog", {
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            spaceBetween: 24,
        ...
        if (document.querySelector(".reviews-swiper")) new Swiper(".reviews-swiper", {
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            spaceBetween: 24,
